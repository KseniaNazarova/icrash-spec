...
\begin{actortable}
	...
	\addsinglerow{lu.uni.lassy.excalibur.icrash.spec.environment.actAuthenticated}
	...
	\addnumbereddoublerow{OUT}{\hypertarget{actCoordinator.outactCoordinator.oeAddMedia}
			{\msrcode{oeAddMedia(ActMedia:ctMedia):ptBoolean}}}
			{sent to indicate that a new media were added.}
	\addnumbereddoublerow{OUT}{\hypertarget{actCoordinator.outactCoordinator.oeRemoveMedia}
			{\msrcode{oeRemoveMedia(AdtMediaID:dtMediaID):ptBoolean}}}
			{sent to indicate that specific media were removed.}
	\addnumbereddoublerow{OUT}{\hypertarget{actCoordinator.outactCoordinator.oeShareByCrisis}
			{\msrcode{oeShareByCrisis(AdtCrisisID:dtCrisisID):ptBoolean}}}
			{sent to indicate that crises were chosen to share.}
	\addnumbereddoublerow{OUT}{\hypertarget{actCoordinator.outactCoordinator.oeChooseMedia}
			{\msrcode{oeChooseMedia(AdtMediaID:dtMediaID):ptBoolean}}}
			{sent to indicate that specific media were chosen to share.}
	\addnumbereddoublerow{OUT}{\hypertarget{actCoordinator.outactCoordinator.oeSendToMedia}
			{\msrcode{oeSendToMedia():ptBoolean}}}
